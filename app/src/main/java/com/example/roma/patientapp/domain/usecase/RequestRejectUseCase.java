...
public class RequestRejectUseCase extends UseCase<RequestStatusResponse> {

    @Inject
    public RequestRejectUseCase(CompositeDisposable compositeDisposable, DataRepository dataRepository) {
    ...
    protected Observable<RequestStatusResponse> buildUseCaseObservable(Map<String, Object> parameters) {
        return dataRepository.rejectRequest(parameters);
    }
}