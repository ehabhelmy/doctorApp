...
public class FinishRequestUseCase extends UseCase<RequestStatusResponse> {

    @Inject
    public FinishRequestUseCase(CompositeDisposable compositeDisposable, DataRepository dataRepository) {
    ...
    protected Observable<RequestStatusResponse> buildUseCaseObservable(Map<String, Object> parameters) {
        return dataRepository.finishRequest(parameters);
    }
}